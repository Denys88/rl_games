...
| use_vecenv | True | auto | Use vecenv to create environment for player. Auto: True when the env registration ships no env_creator (envpool, plain gymnasium entries), else False |

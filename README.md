...
| use_vecenv | True | auto | Use vecenv to create environment for player. Auto: True when the env registration ships no env_creator (envpool, pufferlib, plain gymnasium entries, config-registered `vecenv_type` envs), else False |

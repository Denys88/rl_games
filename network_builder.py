    ...
    def build(self, name, **kwargs):
        ...
        with tf.variable_scope(name, reuse=reuse):   
            ...
            if self.is_dueling:
                ...
                q_values = dense_layer(out, units = actions_num, kernel_initializer = self.init_factory.create(**self.initializer), kernel_regularizer = self.regularizer_factory.create(**self.regularizer), activation=None, name='q_values')
